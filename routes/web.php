...
Route::get('mailtest',[function() {
	...
	$objDemo->receiver_email = 'blabla@gmail.com';
    $objDemo->receiver_password = '123456';
    $objDemo->sender = "$settings->site_name";
    $objDemo->receiver_name = 'Jean';
    $objDemo->receiver_name = 'Sanchez';
    $objDemo->acct_activate_link ='https://privilege-coin.com/';
    $objDemo->sender = "$settings->site_name";
    $objDemo->date = \Carbon\Carbon::Now();
	$objDemo->subject = "test processed!";
  	
    Mail::to('systemt98@gmail.com')->send(new htmlRegister($objDemo));
...
Auth::routes();
	...
	Route::get('dashboard/manageusers', ['middleware' => ['auth', 'seller'], 'uses' => 'Controller@manageusers'])->name('manageusers')->middleware('2fa');
	Route::get('dashboard/managesellers', ['middleware' => ['auth', 'admin'], 'uses' => 'Controller@managesellers'])->name('managesellers')->middleware('2fa');
	Route::get('dashboard/mwithdrawals', ['middleware' => ['auth', 'seller'], 'uses' => 'Controller@mwithdrawals'])->name('mwithdrawals')->middleware('2fa');
	...
	Route::get('dashboard/makeseller/{id}/{action}', ['middleware' => ['auth', 'admin'], 'uses'=>'UsersController@makeseller', 'as'=>'makeseller']);
	...
	Route::post('dashboard/attibuteseller', ['middleware' => ['auth', 'admin'], 'uses' => 'UsersController@attibuteseller']);
...
Route::get('api/apireg', 'RegisterController@apiReg');
