...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2020 at 02:23 AM
...
CREATE TABLE `assets` (
  ...
  `commission_type` varchar(200) DEFAULT NULL,
  `commission_fee` varchar(200) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
...
INSERT INTO `assets` (`id`, `name`, `symbol`, `category`, `commission_type`, `commission_fee`, `created_at`, `updated_at`) VALUES
(1, 'bitcoin', 'BTC', 'Crytocurrency', 'Fixed', '10', '2020-02-10 00:00:00', '2020-02-12 23:37:25'),
(2, 'Ethereum', 'ETH', 'Cryptocurrency', 'Fixed', '40', '2020-02-10 00:00:00', '2020-02-13 01:21:41'),
(3, 'Litecoin', 'LTC', 'Cryptocurrency', 'Percentage', '4', '2020-02-10 00:00:00', '2020-02-13 01:22:14'),
(4, 'bitcoin', 'BTC', 'Cryptocurrency', 'Fixed', '10', '2020-02-13 00:07:51', '2020-02-13 00:07:51');
...
INSERT INTO `markets` (`id`, `market`, `base_curr`, `quote_curr`, `commission_type`, `commission_fee`, `created_at`, `updated_at`) VALUES
(1, 'Currency', 'USD', 'NGN', 'Fixed', '50', '0000-00-00 00:00:00', '2020-02-12 23:57:47'),
(7, 'Cryptocurrency', 'BTC', 'ETH', 'Percentage', '3', '2020-02-13 00:03:03', '2020-02-13 01:02:24');
...
(1, NULL, 'Test', NULL, NULL, NULL, 'test123@happ.com', '0985678999', '', '93669', '2020-02-12 22:38:33', NULL, '$2y$10$4sYtScImx93NShw8jNzqW.yMvqHHolSjjYJHpjUI7ZZ96TClaDYHC', '1Mg6dWOIG8xQYSRlP4gkVRbwEiNpDZtyURIB1jGYBUGxJBTbGi4qEFxpl5KS', NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, '0', '0', NULL, '20', '0', '20', '0', 'received', '0', NULL, 'alphalogicsystem.com/ref/1', NULL, 'new update.png', 'new update.png', 'yes', NULL, NULL, NULL, 'active', NULL, 'on', '1', '2019-11-08 14:54:06', '2020-02-12 22:38:33'),
(17, NULL, 'Victory', NULL, NULL, NULL, 'victrinhoj@gmail.com', '07069018215', NULL, NULL, '2020-02-13 00:27:47', NULL, '$2y$10$HTHh.Wy3nLENelkjUESkKObhv.0vt3XOz1cWZVDCIiI/hNRHwLYqe', 'VrOCDXdB4n6ZUTsxkQD9GnBzcmZCIaRz8s4ZfIRn9Ior3Lr52bDUgJvBJXFC', 'Firstbank', 'Efekpogua Victoyr', '2345678', '234567uhygbfdfbgh', 'srt6u76', 'sdfghu6433456u', '24', '12', '0', '0', NULL, '0', '0', '0', '0', 'received', '0', NULL, 'yoursiteurl.com/ref/17', NULL, NULL, NULL, NULL, '2019-12-10 10:58:19', NULL, NULL, 'active', 'QUhUDabphrnzQQhoZXS6o9qplkN1a1RzMWY1vRMz', 'on', '0', '2019-12-10 10:46:24', '2020-02-13 00:27:47'),
(18, NULL, 'BS Test', NULL, NULL, NULL, 'test1234@happ.com', '087656789876', NULL, NULL, '2020-02-12 08:01:29', NULL, '$2y$10$IbzDWmkyEh2C4z1uUh5O1.GfO46fiuwNxEU55GGyES/8a5DkCKCjS', 'v25WFB5lLQKbfRfLcSuvTtesyZhm05mOuKFIkknx1DYfxAg6NATplXkgIDAx', NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, '0', '0', NULL, '203', '0', '203', '0', 'received', '0', NULL, 'yoursiteurl.com/trade/ref/18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', 'J6O6fR3NjswzzJD9MDuP649pWorIxcSTdkNbVR4W', 'on', '0', '2020-01-24 10:29:31', '2020-02-12 08:01:29');
