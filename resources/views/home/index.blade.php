    ...
    <div class="hero">
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top ml-auto shadow">
          <a class="navbar-brand" href="./"><img src="images/{{$settings->logo}}" target="blank"
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto ml-auto">
              ...
              @guest
              <li class="nav-item">
                <a class="nav-link chng btn  bg-white text-primary " href="register"><i
                    class="fas fa-user-plus"></i>Join</a>
              </li>
              <li class="nav-item">
                <a class="nav-link btn chng bg-white text-primary" href="login"><i class="fas fa-sign-in-alt"></i>
                  Login</a>
              </li>
              @else
              <li class="nav-item avatar dropdown">
                <a id="navbarDropdownMenuLink-55" class="nav-link dropdown-toggle" href="#" role="button"
              ...
              @else
              <li class="nav-item">
                <a class="nav-link btn chng bg-white text-primary" href="{{$settings->bot_link}}"><i
                    class="fas fa-sign-in-alt"></i> Get Started</a>
              </li>
              @endif
            </ul>
        ...
        <section id="" class=" d-sm-block d-md-none">
          <div class="container">
        ...
        <div class="col-md-3 text-center mb-3 wow bounceInLeft">
          <div class="card card-cascade shadow">
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">We follow a strictly customer-centric approach and aim to exceed your expectations.
                That's why we constantly invest in innovation and improve the user experience by introducing native
                applications and platforms, new assets and unique features and tools!
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-3 text-center mb-3 wow bounceInUp">
          <div class="card card-cascade shadow">
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">Straight portfolio and anti-DDOS system to guarantee theft of funds $0 since
                inception in 2017
              </p>
            </div>
          </div>
        ...
        <div class="col-md-3 text-center mb-3 wow bounceInUp">
          <div class="card card-cascade shadow">
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">We believe in educating our customers and giving them all the tools they need to
                respond to a constantly changing market. We offer educational resources to meet the needs of merchants
                at all levels, including live on-site webinars, exclusive video courses and daily market news.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-3 text-center mb-3 wow bounceInRight">
          <div class="card card-cascade shadow">
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">You don't have to wait hours for your coins, the transaction processing time is at
                most 15 minutes!
              </p>
            </div>
          </div>
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-4 mb-4 wow flip">
          <div class="card card-cascade shadow bg-transparent">
            <!-- Card image -->
            <div class="view view-cascade overlay text-center pt-3">
              <img src="{{asset('ot_temp1/img/why-choose-1.png')}}" alt="" class="w-50 text-center"
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">{{$settings->site_name}} clients engage in a large number of successful transactions,
                making them efficient and wealthy.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-4 wow flipInX">
          <div class="card card-cascade shadow bg-transparent">
            <!-- Card image -->
            <div class="view view-cascade overlay text-center pt-3">
              <img src="{{asset('ot_temp1/img/why-choose-2.png')}}" alt="" class="w-50 text-center"
                style="margin: 0px auto;">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">An intuitive, user-friendly and simplistic trading interface helps newcomers to
                easily start trading futures.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-4 wow flip">
          <div class="card card-cascade shadow bg-transparent">
            <!-- Card image -->
            <div class="view view-cascade overlay text-center pt-3">
              <img src="{{asset('ot_temp1/img/why-choose-3.png')}}" alt="" class="w-50 text-center"
                style="margin: 0px auto;">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">Newcomer to the market, therefore not as well known and reliable as the other leading
                stock exchanges but recognized as the most profitable reference program. Its referral program pays 10
                times more than other competitors.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-4 wow flip">
          <div class="card card-cascade shadow bg-transparent">
            <!-- Card image -->
            <div class="view view-cascade overlay text-center pt-3">
              <img src="{{asset('ot_temp1/img/why-choose-4.png')}}" alt="" class="w-50 text-center"
                style="margin: 0px auto;">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">You can easily buy Bitcoin in cash, as well as other cryptocurrencies that we offer
                on the platform. Through this service you can use your credit card to buy Bitcoin, Litecoin, Etherereum,
                Ripple and Bitcoin Cash directly in US Dollars or Euros.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-4 wow flipInX">
          <div class="card card-cascade shadow bg-transparent">
            <!-- Card image -->
            <div class="view view-cascade overlay text-center pt-3">
              <img src="{{asset('ot_temp1/img/why-choose-5.png')}}" alt="" class="w-50 text-center"
                style="margin: 0px auto;">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <p class="card-text">We're with you every step of the way, with 24/7 multilingual helpdesks, personal
                account managers, free product presentations and live market analysis by our experienced analysts.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-4 wow flip">
          <div class="card card-cascade shadow bg-transparent">
            <!-- Card image -->
            <div class="view view-cascade overlay text-center pt-3">
              <img src="{{asset('ot_temp1/img/why-choose-7.png')}}" alt="" class="w-50 text-center"
                style="margin: 0px auto;">
              <a>
                <div class="mask rgba-white-slight"></div>
              </a>
          ...
          <div class="card cd rounded-lg shadow">
            <div class="card-body text-center">
              <h3 class="card-title">{{$plan->name}}</h> <br> <br>
                ...
                <div class="card-body">
                  <a href="login"
                    class="btn-floating bg-purple text-primary btn-block rounded-pill btn btn-action  lighten-3">Buy
                    Now</a>
                </div>
            </div>
          </div>
        ...
        <div class="col">
          <div class="cd-testimonials-wrapper cd-container shadow">
            <ul class="cd-testimonials">
              ...
              <li>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam totam nulla est, illo molestiae maxime
                  officiis, quae ad, ipsum vitae deserunt molestias eius alias.</p>
                <div class="cd-author">
          ...
          <div class="cd-testimonials-all">
            <div class="cd-testimonials-all-wrapper">
              <ul>
                ...
                <li class="cd-testimonials-item">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem quibusdam eveniet,
                    molestiae laborum voluptatibus minima hic quasi accusamus ut facere, eius expedita, voluptatem?
                    Repellat incidunt veniam quaerat, qui laboriosam dicta. Quidem ducimus laudantium dolorum enim qui
                    at ipsum, a error.</p>
                ...
                <li class="cd-testimonials-item">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. At temporibus tempora necessitatibus
                    reiciendis provident deserunt maxime sit id. Dicta aut voluptatibus placeat quibusdam vel, dolore.
                  </p>
      ...
      <div class="row pt-5 pb-5">
        ...
        <div class="col-md-6 offset-md-3 p-3 wow zoomIn">
          <div class="mb-4 text-center">
            <a href="mailto:{{$settings->contact_email}}" class="text-white" style="font-size: large;"><i
                class="fa fa-envelope"></i> {{$settings->contact_email}} </a>
            &nbsp;
          ...
          <div class="accordion" id="accordionExample">
            <div class="card mb-2">
              <div class="card-header bg-primary" id="headingOne">
                <h2 class="mb-0">
                  <button class="btn captext text-white btn-link collapsed" type="button" data-toggle="collapse"
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body"> Bitcoin is a digital currency created in January 2009. It follows the ideas
                  outlined in a white paper by the mysterious developer (or group of developers) Satoshi Nakamoto, whose
                  true identity has not yet been verified. Bitcoin offers the promise of lower transaction fees than
                  traditional online payment mechanisms and is managed by a decentralized authority, unlike
                  government-issued currency.
                  There is no physical Bitcoin, only balances kept on a public book, which - like all Bitcoin
                  transactions - is verified by a massive amount of computing power. Bitcoins are not issued or
                  guaranteed by banks or governments, and individual Bitcoins have no value as a commodity. Although not
                  legal tender, Bitcoins are very popular and have triggered the launch of hundreds of other virtual
                  currencies.
                </div>
              </div>
            </div>
            ...
            <div class="card mb-2">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body">
                  ...
                  <br>Free crypto currencies portfolios are available for all major operating systems and devices to
                  meet a wide variety of your needs. For example, you can install an application on your mobile device
                  for everyday use or you can have a wallet just for online payments on your computer. Either way,
                  choosing a wallet is easy and can be done in minutes.
                  <br>2) Getting crypto currencies
                  <br>You can obtain crypto currencies by accepting them as payment for goods and services. There are
                  also several ways to buy crypto currencies.
                  <br>3) Spending crypto currency
                  <br>An increasing number of services and merchants are accepting crypto currencies worldwide. Use
                  crypto currency to pay them and evaluate your experience to help them gain visibility.
                </div>
              </div>
            </div>
            ...
            <div class="card mb-2">
              <div class="card-headers bg-primary" id="headingThree">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed captext text-white" type="button" data-toggle="collapse"
    ...
    <div class="container-fluid">
      <div class="row bg-light">
        ...
        <div class="col text-white pb-3 ">
          ...
          <div class="row">
            <div class="col text-white pt-4">
              <a href="https://{{$settings->site_name}}.com/ot_temp1/pdf/terms.pdf" class="text-primary">Privacy
                polity</a>
            </div>
          </div>
