...
<link href="{{ asset('css/fas/css/all.css')}}" rel="stylesheet"> 
<!-- //font-awesome icons -->
 <!-- js-->
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="{{ url('/dashboard') }}" class="active"><i class="fas fa-tachometer-alt nav_icon"></i>Dashboard</a>
						</li>
						<li class="">
						...
						<li>
							<a href="{{ url('dashboard/support') }}"><i class="fas fa-hands-helping nav_icon"></i>Support</a>
						...
						<li>
							<a href="{{ url('dashboard/deposits') }}"><i class="fas fa-hand-holding-usd nav_icon"></i>Deposits</a>
						</li>

						<li>
							<a href="{{ url('dashboard/withdrawals') }}"><i class="fas fa-dollar-sign nav_icon"></i>Withdraw profit</a>
						</li>
						...
						<li>
							<a href="{{ url('dashboard/mdeposits') }}"><i class="fas fa-hand-holding-usd nav_icon"></i>Deposits</a>
						</li>
						...
						@if(Auth::user()->type =='1')
						<li>
							<a href="{{ url('dashboard/settings') }}"><i class="fas fa-cog nav_icon"></i>Settings</a>
						</li>
						<li>
							<a href="{{ url('dashboard/managesellers') }}"><i class="fas fa-user-tie nav_icon"></i>Manage sellers</a>
						</li>
						<li>
		...
		<div class="sticky-header header-section ">
			...
			<div class="header-right">
				<div class="profile_details" style="padding:8px; margin-top:15px;">	
					@if(Auth::user()->type =='0')
					<a href="{{ url('trade/exchange') }}" class="btn btn-danger text-white">Live Trading</a> &nbsp;
					@endif
					@if(Auth::user()->type =='0')
