			...
			<div class="main-page signup-page">
                ...
                <div id="exTab2" class="container">	
					<ul class="nav nav-tabs">
						...
						<li>
							<a href="#4" data-toggle="tab">Bonus/Switch</a>
						</li>
						<li>
							<a href="#5" data-toggle="tab">Payment Settings</a>
						</li>
						<li>
							<a href="#6" data-toggle="tab">Investment</a>
						</li>
						<li>
							<a href="#7" data-toggle="tab">Live Trading</a>
						</li>
					</ul>
									...
									<!--<div class="sign-u">
										...
										<div class="sign-u">
											...
											<div class="sign-u">
												...
												<input type="radio" id="colour3" value="pro" name="site_colour"> Pro <span style="border-radius:150px; background-color:#70b429; color:#70b429;">33</span>
												</div>
												<div class="clearfix"> </div>
											</div>
											<?php
