	...
	<div class="main-page signup-page">
		...
		<div class="sign-u">
			<div class="sign-up1 alert-success" style="padding:20px; text-align:center;">
				<h4>You are to send <strong>{{$amount}} {{$coin}}</strong> to the address below or scan the QR code to
					complete payment.</h4>
		...
		<form action="charge" method="post">
			...
			<script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{$settings->s_p_k}}"
				data-image="https://stripe.com/img/documentation/checkout/marketplace.png"
				data-name="{{$settings->site_name}}" data-description="Account fund" data-amount="{{$t_p}}"
				data-locale="auto">
			</script>
		</form>
		@else
		<div class="sign-u" style="background-color:#fff; padding:20px;">
			<div class="sign-up1">
				<h4>You are to make payment of <strong>{{$settings->currency}}{{$amount}}</strong> using your preferred
					mode of payment below.</h4>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#bank">
							...
							<img src="{{ asset('public/home/images/bank-transfer.png')}}" width="70px;" height="40px;">
						</a>
					</h4>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#eth">
							...
							<img src="{{ asset('public/home/images/eth.png')}}" width="60px;" height="60px;">
						</a>
					</h4>
					<div id="eth" class="panel-collapse collapse">
						<div class="alert alert-success alert-dismissable">
							<h4>
								...
								<a href="{{ url('dashboard/cpay') }}/{{$amount}}/ETH/{{ Auth::user()->id }}/new"
									class="btn btn-default">Automatic payment method</a>
								@endif
							</h4>
						</div>
					</div>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#btc">
							...
							<img src="{{ asset('public/home/images/btc.png')}}" width="60px;" height="60px;">
						</a>
					</h4>
					<div id="btc" class="panel-collapse collapse">
						<div class="alert alert-success alert-dismissable">
							<h4>
								...
								<br /><br />
								@if($settings->withdrawal_option != "manual")
								<a href="{{ url('dashboard/cpay') }}/{{$amount}}/BTC/{{ Auth::user()->id }}/new"
									class="btn btn-default">Automatic payment method</a>
								@endif
							</h4>
						</div>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#ltc">
							...
							<img src="{{ asset('public/home/images/ltc.png')}}" width="60px;" height="60px;">
						</a>
					</h4>
					<div id="ltc" class="panel-collapse collapse">
						<div class="alert alert-success alert-dismissable">
							<h4>
								...
								<br /><br />
								@if($settings->withdrawal_option != "manual")
								<a href="{{ url('dashboard/cpay') }}/{{$amount}}/LTC/{{ Auth::user()->id }}/new"
									class="btn btn-default">Automatic payment method</a>
								@endif
							</h4>
						</div>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#stripe">
							<strong>Credit card
								<img src="{{ asset('public/home/images/c3.jpg')}}" width="70px;" height="40px;">
								<img src="{{ asset('public/home/images/c2.jpg')}}" width="70px;" height="40px;">
							</strong>
						</a>
					</h4>
					<div id="stripe" class="panel-collapse collapse">
						<div class="alert alert-success alert-dismissable">
							<h4>
								...
								<br />
								<a href="{{ url('dashboard/paywithcard') }}/{{$amount}}" class="btn btn-default">Pay
									with card</a>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#paypal">
							<strong>PayPal</strong> <img src="{{ asset('public/home/images/pp.png')}}" width="60px;"
								height="60px;">
						</a>
					</h4>
				...
				<div class="panel panel-default" style="border:0px solid #fff;">
					...
					<h4>
						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#PrivilegeCoin">
							<strong>PrivilegeCoin Pay</strong> <img src="{{ asset('public/home/images/c3.jpg')}}"
								width="70px;" height="40px;">
							<img src="{{ asset('public/home/images/c2.jpg')}}" width="70px;" height="40px;">
						</a>
					</h4>
					<div id="PrivilegeCoin" class="panel-collapse collapse">
						<div class="alert alert-success alert-dismissable">
							<a href="http://pay.privilege-coin.com/" class="btn btn-default" target="_blank">Pay with
							PrivilegeCoin</a>
